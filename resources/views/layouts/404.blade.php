...
<div id="notfound">
    <div class="notfound">
        ...
        <p>Страница, которую вы ищете, могла быть удалена из-за изменения названия или временно недоступна.</p>
        <a href="{{ route('profile.index') }}">Вернуться на главную</a>
    </div>
</div>
</body>
</html>
